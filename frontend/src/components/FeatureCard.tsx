        ...
        <div className="relative bg-gradient-to-r from-teal-700 to-teal-500 text-white rounded-xl px-6 py-4 md:px-10 md:py-6 shadow-lg flex flex-row items-center gap-8 overflow-visible max-w-6xl mx-auto border-2 border-orange-200 animate-fadeIn">
            ...
            <div className="flex-1">
                ...
                <p className="text-sm md:text-base leading-relaxed mb-4">
                    Develop essential work readiness skills and support education, training, and employment for all
                    community members.
                </p>

                <Link href="/team">
                    <button className="bg-white text-teal-700 font-semibold px-5 py-2 rounded shadow hover:bg-gray-100 transition">
                        Learn More About Us
                    </button>
                </Link>
            </div>
