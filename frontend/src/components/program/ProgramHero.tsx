        ...
        <section className="py-12 md:py-20 bg-white">
            <div className="container mx-auto max-w-6xl px-4">
                ...
                <div className="text-center mb-12">
                    <h1 className="text-[#00464D] text-4xl md:text-5xl lg:text-6xl font-bold mb-6">
                        {title}
                    </h1>
                    <p className="max-w-3xl mx-auto text-lg md:text-xl text-[#212020]">
                        {description}
                    </p>
                ...
                <div className="grid md:grid-cols-2 gap-8 items-start">
                    <div className="relative flex flex-col items-start">
                        {images && images.length > 0 && (
                            <div className="relative w-full rounded-xl overflow-hidden shadow-lg z-20"
                    ...
                    <div className="border border-[#FF7001] rounded-xl p-6 md:p-8 shadow-sm flex flex-col justify-between">
